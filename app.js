...
function sndFormScale(){
	myscale = document.getElementById("scalechoice").options[document.getElementById("scalechoice").selectedIndex].value;
	if (myscale == "ionian") {
		...
		document.getElementById("scale25").innerHTML = `${_4th} ${document.getElementById("chsus2").innerHTML}`;//Csus4 +3 ()
		document.getElementById("scale26").innerHTML = `${_4th} ${document.getElementById("chmaj7").innerHTML}`;//Fmaj7
		document.getElementById("scale27").innerHTML = `${_4th} ${document.getElementById("chmajadd9").innerHTML}`;//C6sus4
		...
		document.getElementById("scale31").innerHTML = `${_5th} ${document.getElementById("chmaj7").innerHTML}`;//G7 ()
